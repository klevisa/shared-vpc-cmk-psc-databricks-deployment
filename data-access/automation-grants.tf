# -----------------------------------------------------------------------------
# Scoped privileges for the catalog AUTOMATION SP — least privilege, NOT admin.
# The account admin grants the automation SP exactly what it needs to build the
...
# governance group, set after the IdP sync (Phase 1.2, a prereq) — not managed here.
#
