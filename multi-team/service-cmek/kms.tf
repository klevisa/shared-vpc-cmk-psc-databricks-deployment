...
# MANAGED_SERVICES  -> Databricks auto-grants its own SA at registration (Phase 3).
#
# NOTE: the service agents must already exist (Cloud Foundation, Phase 0) or these
